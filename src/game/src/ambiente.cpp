...
const string Ambiente::CAMINHO_IMG = resources_dir_path() + "image/";
const string Ambiente::CAMINHO_MAPAS = resources_dir_path() + "maps/";
const string Ambiente::CAMINHO_AUDIO = resources_dir_path() + "audio/";
const string Ambiente::CAMINHO_FONT = resources_dir_path() + "font/";
